...
\foreach \j in {2cm,16cm}
 ...
 lindenmayer system;};
    ...
    \nodeshadowed [at={(9,7)}] {\Huge  \textcolor{mintgreen}{كريم ٱلقرءان}};
    \nodeshadowed [at={(5,10 )},yslant=0.05] {\textamharic{\Huge\textcolor{orange}{ቁርኣን}}};
    %\nodeshadowed [at={( 0,5.3)}] {\huge \textcolor{mintgreen}{}};
    \nodeshadowed [at={(11,10  )},yslant=-0.05] {\textamharic{\Huge\textcolor{orange}{ከሪም}}};
    \nodeshadowed [at={(9,2 )}] {\large \textamharic{\textcolor{brown}{የቁርኣን ከሪም የአማርኛ ትርጉም}}};
    \nodeshadowed [at={( 9,-1  )}] {\textamharic{\large ((x-በውቀቱ)ቢላል ታድሎ)}تادلو بلال};
