...
sed.*i.*'
sed.*i.*" > 1.cmd
sed -i -r 's/\}\\end/\\end/' 1.tex 
sed -i -r 's/\}\}/\}/' 1.tex 
sed -i -r 's/\}\\/\\/' 1.tex 
sed -i -r 's/\\mytextarabic\{//' 1.tex
sed -i -r 's/\\textarabic\{//' 1.tex
sed -i -r 's/center\\/center\}//' 1.tex 
sed -i -r 's/center\\/center\}/' 1.tex 
sed -i -r 's/center\\/center\}\\/' 1.tex 
sed -i -r 's/\}\\end/\}\}\\end/' 1.tex 
sed -i -r 's/textamhsec/textamharic/' 2.tex 
sed -i -r 's/textamhsec/textamharic/' quranchps2/*.tex
sed -i -r 's/\\textarabic/\\RL/' 2.tex 
sed -i -r 's/\\textarabic/\\RL/' quranchps2/*.tex
sed -i -r 's/\\begin\{center\}/\\centering/' 2.tex 
sed -i -r 's/\\end\{center\}//' 2.tex 
sed -i -r 's/\\end\{center\}//' quranchps2/*.tex
sed -i -r 's/\\mytextarabic\{//' 2.tex 
sed -i -r 's/\\mytextarabic\{//' quranchps2/*.tex
sed -i -r 's/\}\\\\/\\\\/' 2.tex 
sed -i -r 's/\}\\\\/\\\\/' quranchps2/*.tex
sed -i -r 's/\}\\\\/\\\\/' myquran02.tex 
sed -i -r 's/\\mytextarabic\{//' myquran02.tex 
sed -i -r 's/\\end\{center\}//' myquran02.tex 
sed -i -r 's/\\begin\{center\}/\\centering/' myquran02.tex 
sed -i -r 's/\\textarabic/\\RL/' myquran02.tex 
sed.*i.*' > 2.cmd
